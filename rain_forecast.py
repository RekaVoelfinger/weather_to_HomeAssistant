...
def main():
    ...
    logging.info(f"Rainy hours: {will_it_rain(forecast_acw, time_to_int(time_of_query_acw), 'RainProbability')}")
    ...
    logging.info(f"Rainy hours: {will_it_rain(data_forecast_wbit, time_to_int(time_of_query_wbit), 'pop')}")
